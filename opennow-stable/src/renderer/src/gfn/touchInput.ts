 ...
 * mouse/gamepad packets that the desktop path sends. This makes
 * Android able to interact with the streamed game.
 *
 * Strategy
 * --------
...
export class TouchInputHandler {
  ...
  private onTouchMove(e: TouchEvent): void {
    ...
    if (dist > TAP_MOVE_THRESHOLD_PX) state.moved = true;
  ...
  private handleTwoFingerScroll(e: TouchEvent): void {
    ...
    s1.lastX = t1.clientX; s1.lastY = t1.clientY;
    s2.lastX = t2.clientX; s2.lastY = t2.clientY;
